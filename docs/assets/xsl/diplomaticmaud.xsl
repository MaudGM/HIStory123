            ...
            <body>
                ...
                <div class="row" id="footer">
                  <div class="col-sm copyright">
                      ...
                      <div>
                          2022 Maud Guichard-Marneur. The template for the Github repository was designed by Wout Dillen under CC By license at the University of Borås.
                      </div>
                    </div>
                </div>
                </footer>
